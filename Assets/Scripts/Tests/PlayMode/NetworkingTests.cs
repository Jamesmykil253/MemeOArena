...
namespace Tests.PlayMode
{
    ...
    public class NetworkingTests
    {
        ...
        [Test]
        public void SnapshotCopyConstructorWorks()
        {
            var original = new Snapshot(
                42u, // lastProcessedSeq
                100u, // tick
                new Vector3(5f, 1f, 3f), // position
                new Vector3(2f, 0f, 1f), // velocity
                50f, // ultimateEnergy
                3, // carriedPoints
                90, // currentHP
                1, // locomotionState
            ...
            Assert.AreEqual(42u, original.lastProcessedSeq);
            Assert.AreEqual(100u, original.tick);
            Assert.AreEqual(new Vector3(5f, 1f, 3f), original.position);
            Assert.AreEqual(new Vector3(2f, 0f, 1f), original.velocity);
            Assert.AreEqual(50f, original.ultimateEnergy);
            Assert.AreEqual(3, original.carriedPoints);
            Assert.AreEqual(90, original.currentHP);
        }
    }
}
